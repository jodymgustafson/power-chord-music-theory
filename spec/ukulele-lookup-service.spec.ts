...
describe("When use ukulele lookup", () => {
    ...
    describe("When get note number", () => {
        it("string 3, fret 0", () => expect(lookup.getNote(3, 0).name).toBe("A"));
        it("string 2, fret 0", () => expect(lookup.getNote(2, 0).name).toBe("E"));
        it("string 1, fret 0", () => expect(lookup.getNote(1, 0).name).toBe("C"));
        it("string 0, fret 0", () => expect(lookup.getNote(0, 0).name).toBe("G"));

        it("string 3, fret 5", () => expect(lookup.getNote(3, 5).name).toBe("D"));
        it("string 2, fret 5", () => expect(lookup.getNote(2, 5).name).toBe("A"));
        it("string 1, fret 5", () => expect(lookup.getNote(1, 5).name).toBe("F"));
        it("string 0, fret 5", () => expect(lookup.getNote(0, 5).name).toBe("C"));
    });
    ...
    describe("When getChordTab", () => {
        ...
        it("should get tab for D7", () => expect(lookup.getChordTab("D", "7", 0)).toEqual([2, 0, 2, 0]));
